...
public class ChannelService {
    ...
    public ResponseEntity<String> exchangeCodeForToken(KickTokenRequest kickTokenRequest) {
        ...
        String body = UriComponentsBuilder.newInstance()
                ...
                .queryParam("redirect_uri", kickTokenRequest.getRedirectUri())
                .queryParam("code_verifier", kickTokenRequest.getCodeVerifier())
                .queryParam("code", kickTokenRequest.getCode())
                .build()
                .toUri()
                .getRawQuery(); // Gets query string format
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Token exchange failed: " + e.getMessage());
        }
    }

    public void addStreamerInfo(String channelName, StreamerInfo streamerInfo, String JWT){
        ...
        if(channel.getStreamerInfo().size() == 3){
            throw new SivantisException("Cannot add more");
        }
