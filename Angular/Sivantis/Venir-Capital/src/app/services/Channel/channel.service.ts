...
export class ChannelService {
  ...
  exchangeCodeForToken(code: string, codeVerifier: string, redirectUri: string) {
    return this.httpClient.post(this.SivantisURL + "/Kick/Token", {
      code: code,
      codeVerifier: codeVerifier,
      redirectUri: environment.FrontEndURL + redirectUri + "/Kick"
    });
  }
