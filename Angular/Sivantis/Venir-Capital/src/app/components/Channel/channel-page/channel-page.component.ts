...
import { EditStreamInfoComponent } from '../../Accessories/Popups/EditStreamInfo/edit-stream-info/edit-stream-info.component';
      ...
      if(result === "connecting Wallet"){
        this.connectWalletService.connectAccount().then(() => {
          ...
          modelRef.result.then(result => {
            ...
            else if(result === "connecting Wallet"){
              this.openFundChannel()
            }
          })
        });
      } 
