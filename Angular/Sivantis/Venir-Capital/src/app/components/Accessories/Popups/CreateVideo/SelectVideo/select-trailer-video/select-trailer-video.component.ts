...
export class SelectTrailerVideoComponent implements OnInit{
  ...
  getNextVideos(){
    if(this.hasSearched){
      this.youtubeAPI.fetchSearchedYouTubeVideos(this.submittedSearchQuery ,this.nextPageToken).subscribe({
        ...
        error: (err:HttpErrorResponse) => {
          this.isScrollHandlerActive = true
          this.alertService.addAlert(err.error.message, "danger")
        },
        complete: () => {}
      }); 
    }
